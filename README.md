...
The data is collected from the below source https://wwwn.cdc.gov/nchs/nhanes/default.aspx.

The above model can be used by any individual, and re evaluate their perception of their own mental health. They might change their thoughts about any consultations.  
